    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-3 sm:p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-4xl font-bold text-white mb-2">Quiz Düzenle</h1>
          <p className="text-sm sm:text-base text-gray-300">Quiz'i düzenleyin ve güncelleyin</p>
        </div>
